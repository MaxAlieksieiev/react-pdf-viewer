...
var PrintIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("path", { d: "M7.5,19.499h9 M7.5,16.499h9 M5.5,16.5h-3c-1.103-0.003-1.997-0.897-2-2v-6c0.003-1.103,0.897-1.997,2-2h19\n            c1.103,0.003,1.997,0.897,2,2v6c-0.003,1.103-0.897,1.997-2,2h-3\n            M5.5,4.5v-4h9.586c0.265,0,0.52,0.105,0.707,0.293l2.414,2.414\n            C18.395,3.394,18.5,3.649,18.5,3.914V4.5\n            M18.5,22.5c0,0.552-0.448,1-1,1h-11c-0.552,0-1-0.448-1-1v-9h13V22.5z\n            M3.5,8.499\n            c0.552,0,1,0.448,1,1s-0.448,1-1,1s-1-0.448-1-1S2.948,8.499,3.5,8.499z\n            M14.5,0.499v4h4" }) })); };
...
var PrintButton = function (_a) {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { ariaControlsSuffix: "print", position: core.Position.BottomCenter, target: jsxRuntime.jsx(core.MinimalButton, { ariaKeyShortcuts: ariaKeyShortcuts, ariaLabel: label, testId: "print__button", onClick: onClick, children: jsxRuntime.jsx(PrintIcon, {}) }), content: function () { return label; }, offset: TOOLTIP_OFFSET }));
};
...
var CheckPrintPermission = function (_a) {
    ...
    return isAllowed ? (jsxRuntime.jsx(jsxRuntime.Fragment, {})) : (jsxRuntime.jsx(core.Modal, { ariaControlsSuffix: "print-permission", closeOnClickOutside: false, closeOnEscape: false, content: function (toggle) {
            var close = function () {
                toggle();
                store.update('printStatus', PrintStatus.Cancelled);
            };
            return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { className: "rpv-print__permission-body", children: l10n && l10n.print
                            ? l10n.print.disallowPrint
                            : 'The document does not allow to print' }), jsxRuntime.jsx("div", { className: "rpv-print__permission-footer", children: jsxRuntime.jsx(core.Button, { onClick: close, children: l10n && l10n.print ? l10n.print.close : 'Close' }) })] }));
        }, isOpened: true }));
};
...
var PrintProgress = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "rpv-print__progress", children: jsxRuntime.jsxs("div", { className: core.classNames({
                'rpv-print__progress-body': true,
                'rpv-print__progress-body--rtl': isRtl,
            }), children: [jsxRuntime.jsx("div", { className: "rpv-print__progress-message", children: l10n && l10n.print
                        ? l10n.print.preparingDocument
                        : 'Preparing document ...' }), jsxRuntime.jsx("div", { className: "rpv-print__progress-bar", children: jsxRuntime.jsx(core.ProgressBar, { progress: progress }) }), jsxRuntime.jsx(core.Button, { onClick: onCancel, children: l10n && l10n.print ? l10n.print.cancel : 'Cancel' })] }) }));
};
...
var PageThumbnail = function (_a) {
    ...
    return (src && (jsxRuntime.jsx("div", { className: "rpv-print__page", children: jsxRuntime.jsx("img", { "data-testid": "print__thumbnail-".concat(pageIndex), src: src, onLoad: handleImageLoad }) })));
};
...
var PageThumbnailContainer = function (_a) {
    ...
    return (page && (jsxRuntime.jsx(PageThumbnail, { canvas: canvas, page: page, pageHeight: isVertical ? pageSize.pageHeight : pageSize.pageWidth, pageIndex: pageIndex, pageWidth: isVertical ? pageSize.pageWidth : pageSize.pageHeight, rotation: rotationNumber, onLoad: onLoad })));
};
...
var PrintZone = function (_a) {
    ...
    return reactDom.createPortal(jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [printPages.map(function (pageIndex, loopIndex) { return (jsxRuntime.jsx(PageThumbnailContainer, { canvas: canvas, doc: doc, pageIndex: pageIndex, pageRotation: pagesRotation.has(pageIndex) ? pagesRotation.get(pageIndex) : 0, pageSize: pageSizes[pageIndex], rotation: rotation, shouldRender: loopIndex === numLoadedPages, onLoad: onLoad }, pageIndex)); }), jsxRuntime.jsx("style", { dangerouslySetInnerHTML: {
...
var PrintContainer = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [printStatus === PrintStatus.CheckingPermission && jsxRuntime.jsx(CheckPrintPermission, { doc: doc, store: store }), printStatus === PrintStatus.Preparing &&
                (renderProgressBar ? (renderProgressBar(numLoadedPagesForPrint, numPrintPages, cancelPrinting)) : (jsxRuntime.jsx(PrintProgress, { numLoadedPages: numLoadedPagesForPrint, numPages: numPrintPages, onCancel: cancelPrinting }))), (printStatus === PrintStatus.Preparing || printStatus === PrintStatus.Ready) &&
                numLoadedPagesForPrint <= numPrintPages && (jsxRuntime.jsx(PrintZone, { doc: doc, numLoadedPages: numLoadedPagesForPrint, pagesRotation: pagesRotation, pageSizes: pageSizes, printPages: printPages, printStatus: printStatus, rotation: rotation, onCancel: cancelPrinting, onLoad: onLoadPage }))] }));
};
...
var PrintMenuItem = function (_a) {
    ...
    var l10n = React__namespace.useContext(core.LocalizationContext).l10n;
    var label = l10n && l10n.print ? l10n.print.print : 'Print';
    return (jsxRuntime.jsx(core.MenuItem, { icon: jsxRuntime.jsx(PrintIcon, {}), testId: "print__menu", onClick: onClick, children: label }));
};
...
var printPlugin = function (props) {
    ...
    var PrintDecorator = function (props) { return (jsxRuntime.jsx(Print, __assign({ enableShortcuts: printPluginProps.enableShortcuts }, props, { store: store }))); };
    var PrintButtonDecorator = function () { return jsxRuntime.jsx(PrintDecorator, { children: function (props) { return jsxRuntime.jsx(PrintButton, __assign({}, props)); } }); };
    var PrintMenuItemDecorator = function (props) { return (jsxRuntime.jsx(PrintDecorator, { children: function (p) { return (jsxRuntime.jsx(PrintMenuItem, { onClick: function () {
                p.onClick();
                props.onClick();
            } })); } })); };
    var renderViewer = function (renderViewerProps) {
        ...
        var updateSlot = {
            children: (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [printPluginProps.enableShortcuts && (jsxRuntime.jsx(ShortcutHandler, { containerRef: renderViewerProps.containerRef, store: store })), jsxRuntime.jsx(PrintContainer, { doc: renderViewerProps.doc, pagesRotation: renderViewerProps.pagesRotation, pageSizes: renderViewerProps.pageSizes, renderProgressBar: props === null || props === void 0 ? void 0 : props.renderProgressBar, rotation: renderViewerProps.rotation, setPages: printPluginProps.setPages, store: store }), slot.children] })),
        };
