import { PdfJsApiContext, Viewer, type PdfJsApiProvider } from '@max_alieksieiev/react-pdf-viewer-core';
import { defaultLayoutPlugin } from '@max_alieksieiev/react-pdf-viewer-default-layout';
