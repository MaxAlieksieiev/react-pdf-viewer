...
var LocalePopover = function (_a) {
    ...
    var renderTarget = function (toggle, opened) {
        var label = l10n && l10n.localeSwitcher
            ...
            : 'Switch locale';
        return (jsxRuntime.jsx(core.Tooltip, { ariaControlsSuffix: "locale-switcher", position: core.Position.BottomCenter, target: jsxRuntime.jsx(core.MinimalButton, { ariaLabel: label, isSelected: opened, testId: "locale-switcher__popover-target", onClick: toggle, children: jsxRuntime.jsx(LocaleIcon, {}) }), content: function () { return label; }, offset: { left: 0, top: 8 } }));
    };
    var renderContent = function (toggle) {
        ...
        return (jsxRuntime.jsx(core.Menu, { children: Object.keys(locales).map(function (loc) {
                return (jsxRuntime.jsx(core.MenuItem, { checked: initialLocale === loc, onClick: function () { return changeLocale(loc); }, children: locales[loc] }, loc));
            }) }));
    };
    return (jsxRuntime.jsx(core.Popover, { ariaControlsSuffix: "locale-switcher", ariaHasPopup: "menu", position: core.Position.BottomRight, target: renderTarget, content: renderContent, offset: { left: 0, top: 8 }, closeOnClickOutside: true, closeOnEscape: true }));
};

var localeSwitcherPlugin = function () {
    var LocalePopoverDecorator = function (props) { return jsxRuntime.jsx(LocalePopover, __assign({}, props)); };
    return {
