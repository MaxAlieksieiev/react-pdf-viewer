...
var HandToolIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("path", { d: "M11.5,5.5v-2C11.5,2.672,12.172,2,13,2s1.5,0.672,1.5,1.5v2 M14.5,11.5v-6C14.5,4.672,15.172,4,16,4\n            c0.828,0,1.5,0.672,1.5,1.5v3 M17.5,13V8.5C17.5,7.672,18.172,7,19,7s1.5,0.672,1.5,1.5v10c0,2.761-2.239,5-5,5h-3.335\n            c-1.712-0.001-3.305-0.876-4.223-2.321C6.22,18.467,4.083,14,4.083,14c-0.378-0.545-0.242-1.292,0.303-1.67\n            c0.446-0.309,1.044-0.281,1.458,0.07L8.5,15.5v-10C8.5,4.672,9.172,4,10,4s1.5,0.672,1.5,1.5v6" }) })); };

var TextSelectionIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("path", { d: "M13.675,11.671l2.941-2.941c0.195-0.196,0.195-0.512-0.001-0.707C16.563,7.971,16.5,7.931,16.43,7.906\n            L4.168,3.527C3.908,3.434,3.622,3.57,3.529,3.83c-0.039,0.109-0.039,0.228,0,0.336l4.379,12.262\n            c0.093,0.26,0.379,0.396,0.639,0.303c0.07-0.025,0.133-0.065,0.185-0.117l2.943-2.943l6.146,6.146c0.195,0.195,0.512,0.195,0.707,0\n            l1.293-1.293c0.195-0.195,0.195-0.512,0-0.707L13.675,11.671z" }) })); };
        ...
        default:
            label =
                l10n && l10n.selectionMode
                    ...
                    : 'Text selection tool';
            icon = jsxRuntime.jsx(TextSelectionIcon, {});
            break;
    }
...
var SwitchSelectionModeButton = function (_a) {
    ...
    return (jsxRuntime.jsx(SwitchSelectionModeDecorator, { mode: mode, onClick: onClick, children: function (props) { return (jsxRuntime.jsx(core.Tooltip, { ariaControlsSuffix: "selection-mode-switch", position: core.Position.BottomCenter, target: jsxRuntime.jsx(core.MinimalButton, { ariaLabel: props.label, isSelected: isSelected, testId: testId, onClick: props.onClick, children: props.icon }), content: function () { return props.label; }, offset: TOOLTIP_OFFSET })); } }));
};
...
var SwitchSelectionMode = function (_a) {
    ...
    var defaultChildren = function (props) { return (jsxRuntime.jsx(SwitchSelectionModeButton, { isSelected: isSelected, mode: props.mode, onClick: props.onClick })); };
...
var SwitchSelectionModeMenuItem = function (_a) {
    ...
    return (jsxRuntime.jsx(SwitchSelectionModeDecorator, { mode: mode, onClick: onClick, children: function (props) { return (jsxRuntime.jsx(core.MenuItem, { checked: isSelected, icon: props.icon, testId: testId, onClick: props.onClick, children: props.label })); } }));
};
...
var selectionModePlugin = function (props) {
    ...
    var SwitchSelectionModeDecorator = function (props) { return (jsxRuntime.jsx(SwitchSelectionMode, __assign({}, props, { store: store }))); };
    var SwitchSelectionModeButtonDecorator = function (props) { return (jsxRuntime.jsx(SwitchSelectionModeDecorator, { mode: props.mode, children: function (p) { return (jsxRuntime.jsx(SwitchSelectionModeButton, { isSelected: p.isSelected, mode: p.mode, onClick: function () {
                p.onClick();
            } })); } })); };
    var SwitchSelectionModeMenuItemDecorator = function (props) { return (jsxRuntime.jsx(SwitchSelectionModeDecorator, { mode: props.mode, children: function (p) { return (jsxRuntime.jsx(SwitchSelectionModeMenuItem, { isSelected: p.isSelected, mode: p.mode, onClick: function () {
                p.onClick();
                props.onClick();
            } })); } })); };
    var renderViewer = function (props) {
        ...
        if (currentSlot.subSlot && currentSlot.subSlot.children) {
            currentSlot.subSlot.children = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Tracker, { store: store }), currentSlot.subSlot.children] }));
        }
        return currentSlot;
    };
    return {
