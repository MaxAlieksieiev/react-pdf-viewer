...
var DualPageCoverViewModeIcon = function () { return (jsxRuntime.jsxs(core.Icon, { size: 16, children: [jsxRuntime.jsx("rect", { x: "0.5", y: "0.497", width: "22", height: "22", rx: "1", ry: "1" }), jsxRuntime.jsx("line", { x1: "0.5", y1: "6.497", x2: "22.5", y2: "6.497" }), jsxRuntime.jsx("line", { x1: "11.5", y1: "6.497", x2: "11.5", y2: "22.497" })] })); };

var DualPageViewModeIcon = function () { return (jsxRuntime.jsxs(core.Icon, { size: 16, children: [jsxRuntime.jsx("rect", { x: "0.5", y: "0.497", width: "22", height: "22", rx: "1", ry: "1" }), jsxRuntime.jsx("line", { x1: "11.5", y1: "0.497", x2: "11.5", y2: "22.497" })] })); };

var HorizontalScrollingIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("path", { d: "M6.5,21.5c0,0.552-0.448,1-1,1h-4c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h4c0.552,0,1,0.448,1,1V21.5z\n            M14.5,21.5c0,0.552-0.448,1-1,1h-4c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h4c0.552,0,1,0.448,1,1V21.5z\n            M22.5,21.5 c0,0.552-0.448,1-1,1h-4c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h4c0.552,0,1,0.448,1,1V21.5z" }) })); };

var PageScrollingIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("rect", { x: "0.5", y: "0.497", width: "22", height: "22", rx: "1", ry: "1" }) })); };

var VerticalScrollingIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("path", { d: "M23.5,5.5c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1V5.5z\n            M23.5,13.5c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1V13.5z\n            M23.5,21.5 c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1V21.5z" }) })); };

var WrappedScrollingIcon = function () { return (jsxRuntime.jsx(core.Icon, { size: 16, children: jsxRuntime.jsx("path", { d: "M10.5,9.5c0,0.552-0.448,1-1,1h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V9.5z\n            M23.5,9.5c0,0.552-0.448,1-1,1h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V9.5z\n            M10.5,22.5 c0,0.552-0.448,1-1,1h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V22.5z\n            M23.5,22.5c0,0.552-0.448,1-1,1 h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V22.5z" }) })); };
...
var SwitchScrollModeDecorator = function (_a) {
    ...
    var label = '';
    var icon = jsxRuntime.jsx(VerticalScrollingIcon, {});
    switch (mode) {
        case core.ScrollMode.Horizontal:
            ...
            icon = jsxRuntime.jsx(HorizontalScrollingIcon, {});
            break;
        case core.ScrollMode.Page:
            label =
                l10n && l10n.scrollMode
                    ...
                    : 'Page scrolling';
            icon = jsxRuntime.jsx(PageScrollingIcon, {});
            break;
        case core.ScrollMode.Wrapped:
            label =
                l10n && l10n.scrollMode
                    ...
                    : 'Wrapped scrolling';
            icon = jsxRuntime.jsx(WrappedScrollingIcon, {});
            break;
        ...
        default:
            label =
                l10n && l10n.scrollMode
                    ...
                    : 'Vertical scrolling';
            icon = jsxRuntime.jsx(VerticalScrollingIcon, {});
            break;
    }
...
var SwitchScrollModeButton = function (_a) {
    ...
    return (jsxRuntime.jsx(SwitchScrollModeDecorator, { mode: mode, onClick: onClick, children: function (props) { return (jsxRuntime.jsx(core.Tooltip, { ariaControlsSuffix: "scroll-mode-switch", position: core.Position.BottomCenter, target: jsxRuntime.jsx(core.MinimalButton, { ariaLabel: props.label, isDisabled: isDisabled, isSelected: isSelected, testId: testId, onClick: props.onClick, children: props.icon }), content: function () { return props.label; }, offset: TOOLTIP_OFFSET$1 })); } }));
};
...
var SwitchScrollMode = function (_a) {
    ...
    var defaultChildren = function (props) { return (jsxRuntime.jsx(SwitchScrollModeButton, { isDisabled: isDisabled, isSelected: isSelected, mode: props.mode, onClick: props.onClick })); };
...
var SwitchScrollModeMenuItem = function (_a) {
    ...
    return (jsxRuntime.jsx(SwitchScrollModeDecorator, { mode: mode, onClick: onClick, children: function (props) { return (jsxRuntime.jsx(core.MenuItem, { checked: isSelected, icon: props.icon, isDisabled: isDisabled, testId: testId, onClick: props.onClick, children: props.label })); } }));
};
...
var SwitchViewModeDecorator = function (_a) {
    ...
    switch (mode) {
        ...
        case core.ViewMode.DualPageWithCover:
            ...
            icon = jsxRuntime.jsx(DualPageCoverViewModeIcon, {});
            break;
...
var SwitchViewModeButton = function (_a) {
    ...
    return (jsxRuntime.jsx(SwitchViewModeDecorator, { mode: mode, onClick: onClick, children: function (props) { return (jsxRuntime.jsx(core.Tooltip, { ariaControlsSuffix: "view-mode-switch", position: core.Position.BottomCenter, target: jsxRuntime.jsx(core.MinimalButton, { ariaLabel: props.label, isDisabled: isDisabled, isSelected: isSelected, testId: testId, onClick: props.onClick, children: props.icon }), content: function () { return props.label; }, offset: TOOLTIP_OFFSET })); } }));
};
...
var SwitchViewMode = function (_a) {
    ...
    var defaultChildren = function (props) { return (jsxRuntime.jsx(SwitchViewModeButton, { isDisabled: isDisabled, isSelected: isSelected, mode: props.mode, onClick: props.onClick })); };
    var render = children || defaultChildren;
    return render({
        isDisabled: isDisabled,
        isSelected: isSelected,
...
var SwitchViewModeMenuItem = function (_a) {
    ...
    return (jsxRuntime.jsx(SwitchViewModeDecorator, { mode: mode, onClick: onClick, children: function (props) { return (jsxRuntime.jsx(core.MenuItem, { checked: isSelected, icon: props.icon, isDisabled: isDisabled, testId: testId, onClick: props.onClick, children: props.label })); } }));
};
...
var scrollModePlugin = function () {
    ...
    var SwitchScrollModeDecorator = function (props) { return jsxRuntime.jsx(SwitchScrollMode, __assign({}, props, { store: store })); };
    var SwitchScrollModeButtonDecorator = function (props) { return (jsxRuntime.jsx(SwitchScrollModeDecorator, { mode: props.mode, children: function (p) { return (jsxRuntime.jsx(SwitchScrollModeButton, { isDisabled: p.isDisabled, isSelected: p.isSelected, mode: p.mode, onClick: function () {
                p.onClick();
            } })); } })); };
    var SwitchScrollModeMenuItemDecorator = function (props) { return (jsxRuntime.jsx(SwitchScrollModeDecorator, { mode: props.mode, children: function (p) { return (jsxRuntime.jsx(SwitchScrollModeMenuItem, { isDisabled: p.isDisabled, isSelected: p.isSelected, mode: p.mode, onClick: function () {
                p.onClick();
                props.onClick();
            } })); } })); };
    var SwitchViewModeDecorator = function (props) { return jsxRuntime.jsx(SwitchViewMode, __assign({}, props, { store: store })); };
    var SwitchViewModeButtonDecorator = function (props) { return (jsxRuntime.jsx(SwitchViewModeDecorator, { mode: props.mode, children: function (p) { return (jsxRuntime.jsx(SwitchViewModeButton, { isDisabled: p.isDisabled, isSelected: p.isSelected, mode: p.mode, onClick: function () {
                p.onClick();
            } })); } })); };
    var SwitchViewModeMenuItemDecorator = function (props) { return (jsxRuntime.jsx(SwitchViewModeDecorator, { mode: props.mode, children: function (p) { return (jsxRuntime.jsx(SwitchViewModeMenuItem, { isDisabled: p.isDisabled, isSelected: p.isSelected, mode: p.mode, onClick: function () {
                p.onClick();
                props.onClick();
            } })); } })); };
    return {
