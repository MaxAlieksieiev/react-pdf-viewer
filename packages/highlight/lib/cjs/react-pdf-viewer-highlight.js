...
var MessageIcon = function () { return (jsxRuntime.jsxs(reactPdfViewerCore.Icon, { size: 16, children: [jsxRuntime.jsx("path", { d: "M23.5,17a1,1,0,0,1-1,1h-11l-4,4V18h-6a1,1,0,0,1-1-1V3a1,1,0,0,1,1-1h21a1,1,0,0,1,1,1Z" }), jsxRuntime.jsx("path", { d: "M5.5 12L18.5 12" }), jsxRuntime.jsx("path", { d: "M5.5 7L18.5 7" })] })); };
...
var HighlightRect = function (_a) {
    ...
    return jsxRuntime.jsx("div", { className: "rpv-highlight__selected-text", style: getCssProperties(area, rotation) });
};
...
var HighlightAreaList = function (_a) {
    ...
    var listAreas = highlightState.type === HighlightStateType.Selection
        ...
        : [];
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [renderHighlightTarget &&
                ...
                renderHighlightContent({
                    ...
                    selectionData: highlightState.selectionData,
                    cancel: cancel,
                }), listAreas.length > 0 && (jsxRuntime.jsx("div", { children: listAreas.map(function (area, idx) { return (jsxRuntime.jsx(HighlightRect, { area: area, rotation: rotation }, idx)); }) })), renderHighlights &&
                renderHighlights({
                    pageIndex: pageIndex,
                    rotation: rotation,
...
var getRectFromOffsets = function (textDiv, startOffset, endOffset) {
    ...
    var range = new Range();
    range === null || range === void 0 ? void 0 : range.setStart(firstChild, startOffset);
    range === null || range === void 0 ? void 0 : range.setEnd(firstChild, endOffset);
...
var highlightPlugin = function (props) {
    ...
    var handleMouseDown = function (textLayerRender) { return function (e) {
        if (store.get('trigger') === exports.Trigger.None || e instanceof MouseEvent && e.button !== 0) {
            return;
        }
        ...
        if (highlightState.type === HighlightStateType.Selected) {
            var mouseTop_1 = (e instanceof MouseEvent ? e.clientY : e.touches[0].clientY) - pageRect.top;
            var mouseLeft_1 = (e instanceof MouseEvent ? e.clientX : e.touches[0].clientX) - pageRect.left;
        ...
        var selectionTop = (((e instanceof MouseEvent ? e.clientY : e.touches[0].clientY) - pageRect.top) * 100) / pageRect.height;
    ...
    var renderPageLayer = function (renderPageProps) { return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(ClickDrag, { canvasLayerRef: renderPageProps.canvasLayerRef, canvasLayerRendered: renderPageProps.canvasLayerRendered, pageIndex: renderPageProps.pageIndex, store: store, textLayerRef: renderPageProps.textLayerRef, textLayerRendered: renderPageProps.textLayerRendered }), jsxRuntime.jsx(HighlightAreaList, { pageIndex: renderPageProps.pageIndex, renderHighlightContent: highlightPluginProps.renderHighlightContent, renderHighlightTarget: highlightPluginProps.renderHighlightTarget, renderHighlights: highlightPluginProps.renderHighlights, store: store })] })); };
