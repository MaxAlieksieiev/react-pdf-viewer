...
var DownloadIcon = function () { return (jsxRuntime.jsxs(core.Icon, { size: 16, children: [jsxRuntime.jsx("path", { d: "M5.5,11.5c-.275,0-.341.159-.146.354l6.292,6.293a.5.5,0,0,0,.709,0l6.311-6.275c.2-.193.13-.353-.145-.355L15.5,11.5V1.5a1,1,0,0,0-1-1h-5a1,1,0,0,0-1,1V11a.5.5,0,0,1-.5.5Z" }), jsxRuntime.jsx("path", { d: "M23.5,18.5v4a1,1,0,0,1-1,1H1.5a1,1,0,0,1-1-1v-4" })] })); };
...
var DownloadButton = function (_a) {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { ariaControlsSuffix: "get-file", position: core.Position.BottomCenter, target: jsxRuntime.jsx(core.MinimalButton, { ariaLabel: label, testId: "get-file__download-button", onClick: onClick, children: jsxRuntime.jsx(DownloadIcon, {}) }), content: function () { return label; }, offset: TOOLTIP_OFFSET }));
};
...
var Download = function (_a) {
    ...
    var defaultChildren = function (props) { return jsxRuntime.jsx(DownloadButton, { onClick: props.onClick }); };
...
var DownloadMenuItem = function (_a) {
    ...
    var l10n = React__namespace.useContext(core.LocalizationContext).l10n;
    var label = l10n && l10n.download ? l10n.download.download : 'Download';
    return (jsxRuntime.jsx(core.MenuItem, { icon: jsxRuntime.jsx(DownloadIcon, {}), testId: "get-file__download-menu", onClick: onClick, children: label }));
};
...
var getFilePlugin = function (props) {
    ...
    var DownloadDecorator = function (downloadProps) { return (jsxRuntime.jsx(Download, __assign({}, downloadProps, { fileNameGenerator: props ? props.fileNameGenerator || defaultFileNameGenerator : defaultFileNameGenerator, store: store }))); };
    var DownloadButtonDecorator = function () { return (jsxRuntime.jsx(DownloadDecorator, { children: function (props) { return jsxRuntime.jsx(DownloadButton, __assign({}, props)); } })); };
    var DownloadMenuItemDecorator = function (props) { return (jsxRuntime.jsx(DownloadDecorator, { children: function (p) { return (jsxRuntime.jsx(DownloadMenuItem, { onClick: function () {
                p.onClick();
                props.onClick();
            } })); } })); };
    return {
