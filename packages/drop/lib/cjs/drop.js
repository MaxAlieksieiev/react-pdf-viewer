...
var DropArea = function (_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: isDragging && (jsxRuntime.jsx("div", { className: "rpv-drop__area", children: jsxRuntime.jsx("div", { className: core.classNames({
                    'rpv-drop__area-body': true,
                    'rpv-drop__area-body--rtl': isRtl,
                }), children: l10n && l10n.drop
...
var dropPlugin = function () {
    var renderViewer = function (props) {
        ...
        slot.children = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(DropArea, { containerRef: props.containerRef, openFile: props.openFile }), slot.children] }));
        return slot;
    };
    return {
